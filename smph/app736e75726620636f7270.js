...
if (getBaseUrl().includes("whatsapp")) {
	...
	<a href="https://www.wapi7.com" target="_blank"><button>Wapi Premium</button></a>
	<a href="https://www.waspace.app" target="_blank" style="background-color: #FFFFFF"><button>Wa Space</button></a>
