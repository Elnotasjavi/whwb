        ...
        : function(e) {
          ...
          , l = function() {
            function e(t) {
                ...
                if (this.innerElements==undefined && this.selector.children.length>1 )
            ...
            return s(e, [{
                ...
                value: function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1
                      , t = arguments[1];
                    if (this.innerElements && !(this.innerElements.length <= this.perPage)) {
                        ...
                        if (this.config.loop) {
                            if (this.currentSlide - e < 0) {
                                ...
                                this.sliderFrame.style[this.transformProperty] = "translate3d(" + (l + o) + "px, 0, 0)",
                                this.currentSlide = r - e
                            } else
                                this.currentSlide = this.currentSlide - e
                        } else
                            this.currentSlide = Math.max(this.currentSlide - e, 0);
                        i !== this.currentSlide && (this.slideToCurrent(this.config.loop),
                ...
                value: function(e, t) {
                    if (!(this.innerElements.length <= this.perPage)) {
                        ...
                        i !== this.currentSlide && (this.slideToCurrent(),
                        this.config.onChange.call(this),
                        t && t.call(this))
                    }
                }
